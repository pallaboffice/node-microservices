...
exports.FakeProducts = exports.createRandomProduct = void 0;
// ESM
...
function createRandomProduct() {
    var date = moment(faker.date.past(), 'YYYY-MM-DDTHH:mm:ssZ');
    var isoString = date.toISOString();
    var res = isoString.substring(0, 19).replace('T', ' ');
    return {
...
(0, typeorm_1.createConnection)().then(function (db) {
    var inFun = function (FakeProducts) { return __awaiter(void 0, void 0, void 0, function () {
        var productRepository, prod, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    productRepository = db.getRepository(product_1.Product);
                    console.log(FakeProducts);
                    return [4 /*yield*/, productRepository.create(FakeProducts)];
                case 1:
                    prod = _a.sent();
                    return [4 /*yield*/, productRepository.save(prod)];
                case 2:
                    result = _a.sent();
                    console.log(result);
                    return [2 /*return*/];
